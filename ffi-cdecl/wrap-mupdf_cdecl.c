...
cdecl_func(mupdf_pdf_annot_author)
cdecl_func(mupdf_pdf_set_annot_author)
...
cdecl_func(mupdf_pdf_annot_ink_list_count)
cdecl_func(mupdf_pdf_annot_ink_list_stroke_count)
cdecl_func(mupdf_pdf_annot_ink_list_stroke_vertex)
cdecl_func(mupdf_pdf_annot_color)
cdecl_func(mupdf_pdf_annot_border_width)
cdecl_func(mupdf_pdf_annot_opacity)
cdecl_func(mupdf_pdf_annot_has_ink_list)
