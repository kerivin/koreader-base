...
cdecl_func(pixOtsuAdaptiveThreshold)
cdecl_func(pixOtsuThreshOnBackgroundNorm)
cdecl_func(pixMaskedThreshOnBackgroundNorm)
cdecl_func(pixSauvolaBinarizeTiled)
cdecl_func(pixSauvolaBinarize)
cdecl_func(pixSauvolaOnContrastNorm)