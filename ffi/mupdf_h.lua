...
const char *mupdf_pdf_annot_author(fz_context *, pdf_annot *);
bool mupdf_pdf_set_annot_author(fz_context *, pdf_annot *, const char *);
...
int mupdf_pdf_annot_has_ink_list(fz_context *, pdf_annot *);
typedef struct {
  int do_incremental;
  int do_pretty;
  int do_ascii;
